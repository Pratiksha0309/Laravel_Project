                ...
                <div class="card borde-0 shadow-lg my-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input value="{{old('name',$product->name) }}" type="text" class=" @error('name') is-invalid
                        ...
                        <div class="mb-3">
                            ...
                            <input  value="{{old('sku',$product->sku) }}" type="text" class=" @error('sku') is-invalid
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{old('price',$product->price) }}" type="text" class=" @error('price') is-invalid
                        ...
                        <div class="mb-3">
                           ...
                           <textarea  value="{{old('description',$product->description) }}"placeholder="Description" class="form-control" name="description" id="" cols="30" rows="5"></textarea>
                        </div>
                        <div class="mb-3">
